...
summary: La modalità di accesso alla NetApp Console dipende dalla modalità di distribuzione utilizzata. 
---
...
[role="lead"]
La modalità di accesso alla NetApp Console dipende dalla modalità di distribuzione utilizzata.
...
È possibile accedere alla NetApp Console utilizzando una delle seguenti opzioni:
...
* Un accesso NetApp Console utilizzando il tuo indirizzo email e una password
* Una connessione federata
+
