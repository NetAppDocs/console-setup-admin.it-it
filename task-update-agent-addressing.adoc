...
---
= Aggiorna l'indirizzamento e gli URI dell'agente di NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Aggiorna l'URI di un agente della Console se i requisiti di rete cambiano. Ciò garantisce una gestione ininterrotta, sicura e conforme dell'infrastruttura di storage.
