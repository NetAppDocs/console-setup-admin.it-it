...
---
= Installa un certificato firmato da CA per l'accesso alla NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Quando si utilizza la NetApp Console in modalità riservata o privata, l'interfaccia utente è accessibile dalla macchina virtuale dell'agente Console distribuita nella propria area cloud o in locale. Per impostazione predefinita, la Console utilizza un certificato SSL autofirmato per fornire un accesso HTTPS sicuro alla console basata sul web in esecuzione sull'agente Console.
...
. Nella pagina *Panoramica*, seleziona il menu azioni per un agente Console e seleziona *Configurazione HTTPS*.
+
Dettagli relativi alla visualizzazione del certificato, inclusa la data di scadenza.
