...
.Passi
. Seleziona *Amministrazione > Supporto*.
...
+
Utilizzando questa opzione, ti verrà richiesto di effettuare nuovamente l'accesso. Tieni presente che il token per questi account scade dopo 90 giorni. Verrà pubblicata una notifica per avvisarti di questo.
