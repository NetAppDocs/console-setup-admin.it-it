...
---
= Preparati per la distribuzione in modalità con restrizioni di NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Utilizzare l'interfaccia basata su browser disponibile localmente dall'agente NetApp Console installato. Non è possibile accedere alla NetApp Console dalla console basata sul web fornita tramite l'applicazione SaaS.
...
NOTE: Gli agenti della console precedenti alla versione 4.0.0 supportano endpoint diversi. Se hai eseguito l'aggiornamento alla versione 4.0.0 o successiva, puoi rimuovere i vecchi endpoint dall'elenco degli endpoint consentiti. link:reference-networking-saas-console-previous.html["Scopri di più sull'accesso alla rete richiesto per le versioni precedenti alla 4.0.0."]
