...
Assegna il ruolo di Partnership admin a uno o più utenti sia nell'organizzazione che avvia la partnership sia in quella che la riceve, per creare e gestire le partnership. Puoi assegnare il ruolo di Partnership viewer agli utenti che devono solo visualizzare le partnership, senza gestirle.
