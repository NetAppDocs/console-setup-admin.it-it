...
---
= Scopri la federazione delle identità in NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: La federazione non è disponibile quando NetApp Console è in modalità privata. link:concept-modes.html["Scopri di più sulle modalità NetApp Console"^].
...
.Protocolli
* link:task-federation-adfs.html["Servizi federativi di Active Directory (AD FS)"]
* link:task-federation-saml.html["Provider di identità Security Assertion Markup Language (SAML)"]


.Fornitori di identità
* link:task-federation-entra-id.html["ID di accesso Microsoft"]
...
[role="quick-margin-para"]
Configura il tuo provider di identità per considerare attendibile NetApp creando una nuova applicazione e fornendo dettagli come l'URL ACS, l'Entity ID o altre informazioni sulle credenziali. Le informazioni sul service provider variano a seconda del provider di identità, quindi consulta la documentazione specifica del tuo provider di identità per i dettagli. Dovrai collaborare con l'amministratore del tuo IdP per completare questo passaggio.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quattro"] Metti alla prova la tua federazione nella Console
[role="quick-margin-para"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinque"]Abilita la tua connessione nella Console
[role="quick-margin-para"]
