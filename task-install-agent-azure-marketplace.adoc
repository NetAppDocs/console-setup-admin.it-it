...
---
= Crea un agente NetApp Console dal Marketplace di Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Prima di iniziare
* link:concept-agent-install-options.html#agent-marketplace-deploy["Scopri quando effettuare la distribuzione da Azure Marketplace"].
...
Assicurati che la posizione di rete in cui intendi installare l'agente della Console soddisfi i seguenti requisiti. Questi requisiti consentono all'agente della Console di gestire le risorse nel tuo cloud ibrido.
...
.Risultato
Hai installato ora l'agente Console e lo hai configurato con la tua organizzazione Console.
