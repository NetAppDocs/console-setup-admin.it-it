...
| link:reference-iam-gcnv-roles.html["Utente Google Cloud NetApp Volumes"] | Gli utenti con il ruolo utente Google Cloud NetApp Volumes possono visualizzare Google Cloud NetApp Volumes. 
