...
Per gestire l'identità e l'accesso per la tua organizzazione, sono necessarie le autorizzazioni di *Org admin* o *Super admin*. Con le autorizzazioni di *Folder or project admin*, puoi gestire solo le cartelle e i progetti a cui hai accesso.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinque"]Verifica la tua organizzazione (facoltativo)
[role="quick-margin-para"]
Se il tuo team utilizza la verifica dell'organizzazione, collega la tua organizzazione Console con l'identità del tuo account aziendale NetApp.

[role="quick-margin-para"]
link:task-verify-organization.html["Scopri come verificare la tua organizzazione"].
...
* link:concept-verified-organization.html["Scopri le organizzazioni verificate in NetApp Console"]
