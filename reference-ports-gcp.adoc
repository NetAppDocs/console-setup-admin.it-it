...
summary: 'Le regole del firewall di Google Cloud per l"agente richiedono sia regole inbound che outbound. La NetApp Console crea automaticamente questo gruppo di sicurezza quando si crea un agente dalla Console. Per altre opzioni di installazione, è necessario configurare manualmente questo gruppo di sicurezza.' 
---
= NetApp Console regole del firewall dell'agente in Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Le regole del firewall di Google Cloud per l'agente richiedono sia regole inbound che outbound. La NetApp Console crea automaticamente questo gruppo di sicurezza quando si crea un agente dalla Console. Per altre opzioni di installazione, è necessario configurare manualmente questo gruppo di sicurezza.
...
| DNS | UDP | 53 | DNS | Utilizzato per la risoluzione DNS dalla classificazione dei dati 
|===