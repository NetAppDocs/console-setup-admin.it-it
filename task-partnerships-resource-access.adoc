...
---
= Fornisci l'accesso alle risorse agli utenti partner in NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* link:reference-iam-keystone-roles.html["Amministratore Keystone"]
* link:reference-iam-keystone-roles.html["Visualizzatore Keystone"]
...
. Seleziona il menu delle azioni image:icon-action.png["un'icona con tre punti verticali"] accanto alla partnership stabilita che desideri visualizzare e seleziona *Visualizza dettagli*.
+
