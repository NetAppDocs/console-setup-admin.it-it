...
* link:reference-iam-predefined-roles.html["Visualizzatore di classificazione dei dati"]
...
* link:reference-iam-disaster-rec-roles.html["Amministratore dell'applicazione Disaster Recovery"]
* link:reference-iam-disaster-rec-roles.html["Visualizzatore di Disaster Recovery"]
* link:reference-iam-storage-roles.html["Analista di supporto alle operazioni"]
* link:reference-iam-ransomware-roles.html["Amministratore di Ransomware Resilience"]
* link:reference-iam-ransomware-roles.html["Visualizzatore di resilienza ransomware"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Comportamento utente di Ransomware Resilience amministratore"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Visualizzatore del comportamento dell'utente di Ransomware Resilience"]
