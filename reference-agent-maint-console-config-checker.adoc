...
Scegli uno o più servizi da convalidare. I nomi dei servizi validi sono: *`PLATFORM` che convalidano la connettività di rete agli endpoint richiesti della Console e se le porte richieste sono aperte per l'agente della Console.
