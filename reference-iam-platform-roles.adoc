...
summary: Assegna ruoli di piattaforma agli utenti per concedere autorizzazioni per gestire la NetApp Console, assegnare ruoli, aggiungere utenti, creare agenti della console e gestire federazioni. 
---
...
| Creare, modificare o eliminare sistemi dalla Console (aggiungere o individuare sistemi) | SÌ | SÌ 
