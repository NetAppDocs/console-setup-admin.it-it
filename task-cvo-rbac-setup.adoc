...
. Esamina il ruolo Cloud Volumes ONTAP assegnato a ciascun utente e verifica che sia assegnato a livello di organizzazione, cartella o progetto che contiene il sistema. Per i ruoli predefiniti previsti, vedi link:reference-iam-cvo-roles.html#seeding-mappings-for-existing-users["Mappature di seeding per gli utenti esistenti"].
