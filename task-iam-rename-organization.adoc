...
---
= Rinomina la tua organizzazione NetApp Console e ottieni gli ID
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: 
...
[role="lead"]
La tua organizzazione NetApp Console ha un nome e un ID. Puoi scegliere un nome per la tua organizzazione per facilitarne l'identificazione. Potrebbe anche essere necessario conoscere l'ID dell'organizzazione per utilizzarlo nelle chiamate API.
...
Puoi rinominare la tua organizzazione. Questo è utile se supporti più di un'organizzazione.
...
+
image:screenshot-iam-edit-organization.png["Uno screenshot della pagina Organizzazione che mostra l'icona delle azioni e l'opzione Modifica organizzazione."]
