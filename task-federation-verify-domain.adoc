...
Ad esempio, se si utilizza Microsoft Entra ID, è possibile seguire i passaggi descritti nella documentazione Microsoft link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["Aggiungi un dominio con Microsoft Entra ID"].
