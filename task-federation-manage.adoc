...
[role="lead"]
Puoi gestire la tua federazione nella NetApp Console. Puoi disattivarla, aggiornare le credenziali scadute e anche eliminarla se non ti serve più.
...
[NOTE]
====
* Se hai configurato la federazione utilizzando NetApp Cloud Central, importala tramite la pagina *Federazione* per gestirla nella Console.link:task-federation-import.html["Scopri come importare la tua federazione"]
* È possibile visualizzare gli eventi di gestione della federazione, come l'abilitazione, la disabilitazione e l'aggiornamento delle federazioni, nella pagina Audit. link:task-monitor-cm-operations.html["Scopri di più sulle operazioni di monitoraggio nella NetApp Console."]
...
. Selezionare *Amministrazione > Identità e accesso*.
. Selezionare la scheda *Federazione*.
. Seleziona il menu delle azioni image:button_3_vert_dots.png["un'icona con tre punti verticali"] accanto alla federazione che desideri testare e seleziona *Verifica connessione*.
...
. Selezionare *Amministrazione > Identità e accesso*.
. Selezionare la scheda *Federazione*.
. Seleziona il menu delle azioni image:button_3_vert_dots.png["un'icona con tre punti verticali"] accanto alla federazione che desideri disabilitare e seleziona *Disabilita*.
...
. Seleziona il menu delle azioni image:button_3_vert_dots.png["un'icona con tre punti verticali"] accanto alla federazione che desideri eliminare e seleziona *Elimina*.
