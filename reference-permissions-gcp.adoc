...
| *config.deployments.lock* | NO | SÌ | NO 
...
| *config.preview.list* | NO | SÌ | NO 


| *config.resources.list* | NO | SÌ | NO 
...
| *compute.forwardingRules.create* | Creare regole di inoltro per l'instradamento del traffico verso i servizi backend. | NO | SÌ | NO 


| *compute.forwardingRules.delete* | Elimina le regole di inoltro esistenti. | NO | SÌ | NO 


| *compute.forwardingRules.get* | Recupera i dettagli sulle regole di inoltro esistenti. | NO | SÌ | NO 


| *compute.forwardingRules.setLabels* | Imposta o aggiorna le etichette sulle regole di inoltro per l'organizzazione. | NO | SÌ | NO 


| compute.globalOperations.get | Per conoscere lo stato delle operazioni. | SÌ | SÌ | NO 


| *calcola.controlli.crea* .4+| Crea e gestisci controlli di integrità per monitorare lo stato di salute del servizio backend. | NO | SÌ | NO 
...
| *compute.resourcePolicies.create* .3+| Crea e gestisci policy sulle risorse per la gestione automatizzata delle risorse. | NO | SÌ | NO 
...
| *registrazione.vocidiregistrazione.create* .2+| Crea e instrada voci di registro per il monitoraggio, il debug e l'audit. | SÌ | SÌ | NO 


| *logging.logEntries.route* | SÌ | SÌ | NO 
...
| *calcola.indirizzi.creaInterno* | Creare indirizzi IP interni all'interno della rete VPC per l'allocazione delle risorse. | NO | SÌ | NO 


| *compute.addresses.deleteInternal* | Elimina gli indirizzi IP interni per la pulizia delle risorse. | NO | SÌ | NO 


| *calcola.indirizzi.impostaetichette* | Aggiorna le etichette sulla risorsa Indirizzo. | NO | SÌ | NO 


| *compute.addresses.useInternal* | Utilizzare indirizzi IP interni per la comunicazione di rete. | NO | SÌ | NO 
