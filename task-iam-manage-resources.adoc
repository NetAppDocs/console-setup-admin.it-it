...
NOTE: Gli utenti con il ruolo di amministratore dell'organizzazione possono aggiungere risorse alla cartella per delegare l'attività di associazione della risorsa ai progetti agli amministratori della cartella o del progetto in questione. link:task-iam-manage-folders-projects.html#associate-resource-folder["Scopri come associare una risorsa a una cartella"].
