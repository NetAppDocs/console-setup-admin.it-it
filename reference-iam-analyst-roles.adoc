...
summary: È possibile assegnare agli utenti il ruolo di analista del supporto operativo per consentire loro di accedere ad avvisi e monitoraggio. Gli utenti con questo ruolo possono anche aprire casi di supporto. 
---
= Ruolo di analista del supporto operativo per l'accesso alla NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
