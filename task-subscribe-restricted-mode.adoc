...
---
= Abbonati ai NetApp Intelligent Services in modalità limitata NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Prima di iniziare
Per sottoscrivere i servizi dati, è necessario aver già distribuito un agente Console. È inoltre necessario associare un abbonamento al marketplace alle credenziali cloud connesse a un agente Console.
