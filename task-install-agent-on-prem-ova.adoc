...
---
= Distribuisci un agente Console in locale utilizzando VCenter
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Se sei un utente VMWare, puoi utilizzare un file OVA per distribuire un agente Console nel tuo VCenter. Il download del file OVA o l'URL sono disponibili tramite la NetApp Console.


NOTE: Quando si distribuisce un agente Console con gli strumenti VCenter, è possibile utilizzare la console web della macchina virtuale per eseguire attività di manutenzione. link:task-agent-vm-config.html["Scopri di più sulla console VM per l'agente."]
...
=== Distribuisci l'agente nel tuo ambiente vCenter
