...
Puoi creare fino a sette livelli di cartelle e progetti nella struttura delle risorse della tua organizzazione.  Crea cartelle all'interno di altre cartelle per creare una struttura nidificata per la tua organizzazione.
...
+
** *Nome e posizione*: inserisci un nome e scegli una posizione nella gerarchia per la cartella o il progetto. Posiziona una cartella o un progetto sotto l'organizzazione o all'interno di un'altra cartella.
...
+
Seleziona *Aggiungi un membro* per assegnare l'accesso e un ruolo.
