...
Tieni presente che tu (cliente) non devi interrompere alcun servizio sull'host dell'agente della Console quando applichi aggiornamenti di sicurezza minori.
