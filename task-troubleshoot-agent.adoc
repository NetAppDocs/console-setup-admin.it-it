...
== Verificare l'accesso alla rete e alla porta per l'agente Console
...
Eseguire controlli di configurazione sugli agenti della Console dalla Console o dalla console di manutenzione dell'agente per assicurarsi che possano accedere agli endpoint richiesti e che le porte richieste siano aperte.

È anche possibile eseguire controlli di configurazione utilizzando la console di manutenzione dell'agente.link:reference-agent-maint-console-config-checker.html["Scopri di più sull'utilizzo del comando config-checker validate."]
