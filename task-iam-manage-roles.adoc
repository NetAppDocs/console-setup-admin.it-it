...
Gli utenti con il ruolo di *Amministratore dell'organizzazione* o di *Amministratore della cartella o del progetto* hanno la responsabilità di assegnare ruoli ad altri utenti. È possibile assegnare ruoli di accesso in base al progetto o alla cartella. Assegna ruoli di accesso per progetto o cartella.  Ad esempio, assegnare il ruolo di amministratore Ransomware Resilience a un utente per un progetto e il ruolo di amministratore SnapCenter a un altro.  Per assegnare a un utente il ruolo di amministratore di Ransomware Resilience per tutti i progetti in una cartella, assegna il ruolo a livello di cartella.
...
Assegna i ruoli in base alla tua strategia IAM per migliorare la sicurezza.  I ruoli IAM limitano l'accesso degli utenti solo a ciò che è necessario.
...
Quando aggiungi un membro alla tua organizzazione, ti verrà chiesto di assegnargli un ruolo. Puoi verificare quali ruoli sono attualmente assegnati loro.
