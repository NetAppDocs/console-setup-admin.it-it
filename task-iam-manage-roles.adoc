...
TIP: A un membro a cui è assegnato il ruolo di amministratore dell'organizzazione non possono essere assegnati altri ruoli. Hanno già le autorizzazioni per l'intera organizzazione. A un membro con il ruolo di amministratore di cartella o di progetto non possono essere assegnati altri ruoli all'interno della cartella o del progetto in cui ha già tale ruolo. Entrambi i ruoli garantiscono l'accesso a tutti i servizi nell'ambito a loro assegnato.
...
.. Per annullare l'assegnazione del ruolo a un membro, selezionare image:icon-delete.png["Un'icona che assomiglia a un cestino della spazzatura"] accanto al ruolo per rimuovere il rispettivo ruolo dal membro. Ti verrà chiesto di confermare la rimozione.
