...
---
= Prossimi passaggi per NetApp Console in modalità standard
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Ora che hai effettuato l'accesso e configurato la NetApp Console in modalità standard, gli utenti possono creare e scoprire sistemi di storage e utilizzare i servizi dati NetApp .
