...
image:diagram_permissions_initial_aws.png["Un'immagine concettuale che mostra la Console che distribuisce l'agente della Console in un account AWS. Un criterio IAM viene assegnato a un ruolo IAM, che è collegato alla Console."]
