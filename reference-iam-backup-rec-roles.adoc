...
* *Amministratore del backup di Backup and Recovery*: Eseguire backup su snapshot locali, replicare su storage secondario ed eseguire backup su storage a oggetti in NetApp Backup and Recovery.
* *Amministratore del ripristino di Backup and Recovery*: Ripristina i carichi di lavoro utilizzando NetApp Backup and Recovery.
* *Amministratore della clonazione di backup e ripristino*: Clona applicazioni e dati utilizzando NetApp Backup and Recovery.
