...
* *Amministratore dell'applicazione Disaster Recovery*: crea piani di replica. Modificare i piani di replicazione. Avviare i failover di prova.
* *Visualizzatore Disaster Recovery*: visualizza solo le informazioni.
...
|===
| Caratteristica e azione | Amministratore del ripristino di emergenza | Amministratore del failover del ripristino di emergenza | Amministratore dell'applicazione Disaster Recovery | Visualizzatore di Disaster Recovery 
