...
---
= Gestisci i membri della partnership in NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Seleziona il menu delle azioni image:icon-action.png["un'icona con tre punti verticali"] accanto alla partnership esistente a cui desideri aggiungere membri e seleziona *Aggiungi membri*.
...
. Seleziona *Partnership*.
. Selezionare la scheda *Partnership ricevuta*.
. Seleziona il menu delle azioni image:icon-action.png["un'icona con tre punti verticali"] accanto al membro che desideri rimuovere e seleziona *Rimuovi associazione*.
