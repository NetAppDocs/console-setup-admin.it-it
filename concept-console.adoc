...
summary: 'NetApp Console offre un"esperienza SaaS per l"accesso completo alle funzionalità o un"opzione self-hosted per le organizzazioni con limitazioni di connettività.' 
---
...
[role="lead"]
NetApp Console offre un'esperienza SaaS per l'accesso completo alle funzionalità o un'opzione self-hosted per le organizzazioni con limitazioni di connettività.

Puoi utilizzare NetApp Console in due modi: come esperienza SaaS completamente gestita o come soluzione self-hosted nel tuo ambiente cloud. Con l'opzione SaaS, accedi alla Console tramite console.netapp.com, mentre NetApp gestisce tutta l'infrastruttura, l'autenticazione e gli aggiornamenti. Puoi accedere a tutte le funzionalità direttamente dal tuo browser web. Se scegli l'opzione self-hosted, installi un agente Console nel tuo ambiente AWS, Azure o Google Cloud. L'interfaccia viene eseguita localmente e l'agente mantiene una connettività in uscita limitata a NetApp per attività essenziali come l'autenticazione e gli aggiornamenti.

Scegli l'esperienza SaaS se la tua organizzazione dispone di connettività Internet standard. Potrai beneficiare della configurazione più semplice, degli aggiornamenti automatici e dell'accesso completo a tutti i sistemi di storage NetApp , ai servizi dati e alle funzionalità avanzate. È possibile aggiungere agenti direttamente dalla Console e NetApp si occuperà di tutta la manutenzione.

Seleziona l'opzione self-hosted se la tua organizzazione richiede controlli rigorosi di connettività, sicurezza o conformità, come nel caso della pubblica amministrazione o di settori regolamentati. Ottieni maggiore controllo e isolamento della rete, ma puoi gestire solo determinati sistemi di storage NetApp e utilizzare servizi dati limitati, con alcune funzionalità non disponibili. È possibile installare manualmente un agente Console e accedere alla Console direttamente dall'interfaccia dell'agente locale. Installa il tuo agente tramite il tuo marketplace cloud o tramite installazione manuale: l'agente comunicherà solo in uscita con NetApp, garantendo l'assenza di connessioni Internet in entrata.
...
image:diagram-standard-mode.png["Un'immagine concettuale che mostra l'architettura della modalità standard con Internet pubblico in cui sono disponibili il livello SaaS e l'autenticazione auth0."]
...
image:diagram-restricted-mode.png["Un'immagine concettuale della modalità ristretta."]
