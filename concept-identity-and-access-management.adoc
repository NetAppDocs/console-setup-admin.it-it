...
Le _Risorse_ includono sistemi di archiviazione, abbonamenti Keystone e agenti Console.
...
Sistemi di archiviazione e abbonamenti Keystone:: I sistemi di storage sono le risorse principali gestite in NetApp Console. NetApp Console supporta la gestione di sistemi di archiviazione sia on-premise che cloud. È necessario aggiungere un sistema di archiviazione a un progetto prima che chiunque possa accedervi.
+
--
