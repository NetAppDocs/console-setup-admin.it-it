...
summary: 'La gestione delle identità e degli accessi (IAM) nella NetApp Console consente di controllare l"accesso alle risorse della tua organizzazione.' 
---
...
* link:task-iam-switch-organizations-projects.html["Passare tra progetti e organizzazioni NetApp Console"]
* link:task-iam-rename-organization.html["Rinomina l'organizzazione NetApp Console"]
