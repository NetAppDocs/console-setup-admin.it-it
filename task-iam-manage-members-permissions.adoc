...
Puoi aggiungere un gruppo federato dal tuo provider di identità (IdP) alla tua organizzazione. I membri del gruppo federato ereditano i ruoli assegnati al gruppo nella Console.

.Prima di iniziare:
Prima di aggiungere un gruppo federato, assicurati di aver impostato quanto segue: * Devi aver già configurato la federazione tra il tuo IdP e la Console. link:concept-federation.html["Scopri come impostare una federazione."] * Il gruppo deve già esistere nel tuo IdP. * Devi conoscere il nome esatto del gruppo nel tuo IdP. * Gli utenti appartenenti al gruppo devono essersi già registrati alla NetApp Console e aver ricevuto un ruolo esplicito nella Console.
