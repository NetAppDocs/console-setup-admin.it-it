...
image:diagram_permissions_multiple_azure.png["Un'immagine concettuale che mostra l'account Azure iniziale che riceve le autorizzazioni tramite un ruolo personalizzato e un'identità gestita e due account aggiuntivi che ricevono le autorizzazioni tramite un ruolo personalizzato e un service principal."]
