...
Se hai appena iniziato a usare la Console,link:concept-accounts-aws.html["Scopri come la NetApp Console utilizza le credenziali e le autorizzazioni AWS"] .
...
+
.. *Posizione delle credenziali*: selezionare *Amazon Web Services > NetApp Console*.
