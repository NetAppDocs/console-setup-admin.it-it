...
summary: 'La modalità privata viene in genere utilizzata negli ambienti locali privi di connessione Internet e nelle regioni cloud sicure, tra cui AWS Secret Cloud, AWS Top Secret Cloud e Azure IL6.  La modalità privata non è ancora disponibile con la NetApp Console.  NetApp continua a supportare questi ambienti con l"interfaccia legacy BlueXP . link:<link doc al PDF>' 
---
