...
[NOTE]
====
* La console invia notifiche via e-mail per l'agente, le licenze e gli abbonamenti, NetApp Copy and Sync, NetApp Backup and Recovery e NetApp Ransomware Resilience.
...
.Passi
. Seleziona *Amministrazione > Impostazioni notifiche*.
